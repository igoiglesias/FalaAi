...
class Settings(BaseSettings):
    APP_NAME: str = "FalaAi - Conversor de Texto para Voz"
    APP_VERSION: str = "0.0.1"
    APP_DESCRIPTION: str = "Transforme texto em áudio de forma rápida e fácil! Com o FalaAi, você digita um texto e converte em voz com apenas um clique. Simples, prático e direto, feito pela Agência Camp."
    DEBUG: bool = True
    LOGGING_LEVEL: int = logging.INFO

    CORS: List[str] = ["http://localhost:8000", "https://falaai.agenciacamp.com.br"]
    ...
    SECRET_KEY: str = "ff4887f6ce6c502671ba6916ac535a49"
    ALGORITHM: str = "HS256"
